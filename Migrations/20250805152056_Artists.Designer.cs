...
namespace WebAPIProgram.Migrations
{
    ...
    [Migration("20250805152056_Artists")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPIProgram.Models.Database.Tables.IdentityUserExtended", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebAPIProgram.Models.Database.Tables.IdentityUserExtended", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPIProgram.Models.Database.Tables.Artists", b =>
                {
                    b.HasOne("WebAPIProgram.Models.Database.Tables.IdentityUserExtended", "User")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebAPIProgram.Models.Database.Tables.UserLikedSongs", b =>
                {
                    ...
                    b.HasOne("WebAPIProgram.Models.Database.Tables.IdentityUserExtended", "IdentityUserExtended")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
